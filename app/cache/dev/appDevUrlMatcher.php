    ...
    public function match($pathinfo)
    {
        ...
        if (0 === strpos($pathinfo, '/demo')) {
            ...
            if (0 === strpos($pathinfo, '/demo/hello') && preg_match('#^/demo/hello/(?P<name>[^/\\.]++)(?:\\.(?P<_format>[^/]++))?$#s', $pathinfo, $matches)) {
                return $this->mergeDefaults(array_replace($matches, array('_route' => '_demo_hello')), array (  '_format' => 'html',  '_controller' => 'Acme\\DemoBundle\\Controller\\DemoController::helloAction',));
            }
