 ...
 */
class Profile extends \Acme\ResumeBundle\Entity\Profile implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'name', 'address', 'website', 'email', 'phone');
        }
