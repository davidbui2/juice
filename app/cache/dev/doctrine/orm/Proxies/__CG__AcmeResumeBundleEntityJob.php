 ...
 */
class Job extends \Acme\ResumeBundle\Entity\Job implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return array('__isInitialized__', 'id', 'company', 'position', 'startdate', 'enddate', 'profile');
        }
